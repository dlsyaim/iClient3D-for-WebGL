...
DemoDescription['mRegion'] = {title: '导洞与多面', desc: '此范例展示了导洞多边形和多面的创建方式以及效果。', oper: '点击加载数据增加导洞多边形和多面'}
