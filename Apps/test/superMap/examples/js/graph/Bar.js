...
SuperMap.Feature.Theme.Bar = SuperMap.Class(SuperMap.Feature.Theme.Graph, {
    ...
    assembleShapes: function(){
        ...
        for(var i = 0; i < fv.length; i++){
            ...
            // 柱条 style 
            barParams.style = SuperMap.Feature.ShapeFactory.ShapeStyleTool({fillColor: "#ee9900"}, sets.barStyle, sets.barStyleByFields, sets.barStyleByCodomain, i, fv[i]);
            // 柱条 hover 样式
            barParams.highlightStyle = SuperMap.Feature.ShapeFactory.ShapeStyleTool(null, sets.barHoverStyle);
