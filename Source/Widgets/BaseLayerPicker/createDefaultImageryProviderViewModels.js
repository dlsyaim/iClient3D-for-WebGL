...
Earth at night as seen by NASA/NOAA\'s Suomi NPP satellite.',
        ...
        providerViewModels.push(new ProviderViewModel({
            name : 'Here Map\u00a0II',
            iconUrl : buildModuleUrl('Widgets/Images/ImageryProviders/hereMap.png'),
            tooltip : 'Nokia Here Map\nhttp://http://heremaps.cn/',
            creationFunction : function() {
                return new HereMapImageryProvider({
        ...
        providerViewModels.push(new ProviderViewModel({
            name : 'SuperMap Map\u00a0II',
            iconUrl : buildModuleUrl('Widgets/Images/ImageryProviders/iserverRest.png'),
            tooltip : 'SuperMap iserver restful china400\nhttp://www.supermap.com/',
            creationFunction : function() {
                return new SuperMapImageryProvider({
